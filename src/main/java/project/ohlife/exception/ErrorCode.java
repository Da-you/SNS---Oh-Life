...
/**
 * 에러 형식을 정의하는 enum HttpStatus와 ErrorCode, detail을 저장한다. 개발자가 정의한 새로운 exception을 한곳에서 관리하고 재사용이
 * 가능하다는 장점
 */
@Getter
...
public enum ErrorCode {
  ...
  UNAUTHORIZED_USER(HttpStatus.BAD_REQUEST,40003,"user unauthorize for article update"),
  ...
  FILE_READ_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, 50002, "image file read fail"),
  ILLEGAL_MIME_TYPE(HttpStatus.INTERNAL_SERVER_ERROR, 50003, "illegal mime type"),
  ;
